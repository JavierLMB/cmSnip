...
const useAsyncHandlerSnippet = (
  operation?: "createSnippet" | "getAllSnippets" | "updateSnippet" | "deleteSnippet"
) => {
...
const handleAsyncSuccess = (
  ...
  if (operation === "getAllSnippets") return;
...
export default useAsyncHandlerSnippet;
