...
const useAsyncHandlerUser = (
  operation?: "getAllUsers" | "updateUserRole" | "deleteUser" | "getMe" | "updateMe"
) => {
...
const handleAsyncSuccess = (
  ...
  if (operation === "getAllUsers") return;
  if (operation === "getMe") return;
...
export default useAsyncHandlerUser;
